"""Launches the main game module."""
from random import randint

from graphic_arts.start_game_banner import run_screensaver

# Значение стандартной аттаки
DEFAULT_ATTACK = 5
...
class Character:
    ...
    # Константы для специального умения
    SPECIAL_SKILL = 'Удача'
    SPECIAL_BUFF = 15

    # Обьявляю конструктор класса
    def __init__(self, name: str) -> str:
        self.name = name
    # Методы родительского класса атаки, защиты и спец.атк.
...
def start_training(character):
    """Check the abilities of the selected character."""
    commands = {
...
def choice_char_class(char_name: str) -> Character:
    # Словарь для выбора класса персонажа
...
if __name__ == '__main__':
    """Start the main function in which the
    name of the character is entered.
    """
    run_screensaver()
